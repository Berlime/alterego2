...
![query-screenshot](queryPostMetaData.avif)

| 2. Then in your CPT meta-field: Define the Value Field and Label Field.

![query-screenshot](queryPostMetaData2.avif)
...
![jetengineAdminColumns](jetengineAdminColumns.avif)

| 2. Then, in the "Callback" section, click `Select from existing callbacks`

![jetengineAdminColumns](jetengineAdminColumns1.avif)

| 3. Click on the highlighted text in the `Get related items`.

![jetengineAdminColumns](jetengineAdminColumns3.avif)

| 4. Select an option, and you are done!

![jetengineAdminColumns](jetengineAdminColumns4.avif)
